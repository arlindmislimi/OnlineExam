                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group"><label for="company" class=" form-control-label">New Exam Category</label><input type="text" name="examname" placeholder="Add Exam Category" class="form-control"></div>
                                    <div class="form-group"><label for="vat" class=" form-control-label">Exam Time In Minutes</label><input type="text" name="examtime" placeholder="Minutes" class="form-control"></div>
                                    ...
                                    while($row=mysqli_fetch_array($res))
                                    {
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td><a href="editexam.php?id=<?php echo $row["id"];?>">Edit</ad></td>
...
{
    mysqli_query($connection,"insert into exam_category values(NULL,'$_POST[examname]','$_POST[examtime]')") or die (mysqli_error($connection));
